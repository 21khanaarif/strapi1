...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    event_participant: Attribute.Relation<
      'api::event.event',
      'manyToOne',
      'api::event-participant.event-participant'
    >;
    event_registrant: Attribute.Relation<
      'api::event.event',
      'manyToOne',
      'api::event-registrant.event-registrant'
    >;
...
export interface ApiEventOrganiserEventOrganiser extends Schema.CollectionType {
  collectionName: 'event_organisers';
  info: {
    singularName: 'event-organiser';
    pluralName: 'event-organisers';
    displayName: 'Event_Organiser';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiEventParticipantEventParticipant
  ...
  attributes: {
    Participant_Id: Attribute.Integer;
    Event_Id: Attribute.Integer;
    Participant_Role: Attribute.String;
    Ticket_Id: Attribute.Integer;
    events: Attribute.Relation<
      'api::event-participant.event-participant',
      'oneToMany',
      'api::event.event'
...
export interface ApiEventRegistrantEventRegistrant
  extends Schema.CollectionType {
  ...
  attributes: {
    Registrant_Id: Attribute.Integer;
    Event_Id: Attribute.Integer;
    Registrant_Type: Attribute.String;
    Registration_Date: Attribute.DateTime;
    Registration_Status: Attribute.String;
    event_participants: Attribute.Relation<
      'api::event-registrant.event-registrant',
      'oneToMany',
      'api::event-participant.event-participant'
    >;
...
export interface ApiGeneralUserGeneralUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    event_organisers: Attribute.Relation<
      'api::general-user.general-user',
      'oneToMany',
      'api::event-organiser.event-organiser'
    >;
    event_registrants: Attribute.Relation<
      'api::general-user.general-user',
      'oneToMany',
      'api::event-registrant.event-registrant'
    >;
...
export interface ApiInvoiceInvoice extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Event_Id: Attribute.Integer;
    User_Id: Attribute.Integer;
    Transaction_Id: Attribute.Integer;
...
export interface ApiPaymentMethodPaymentMethod extends Schema.CollectionType {
  ...
  attributes: {
    Payment_Method_Id: Attribute.Integer;
    User_Id: Attribute.Integer;
    Payment_Type: Attribute.String;
    Processing_Fee: Attribute.Float;
...
export interface ApiPaymentTransactionPaymentTransaction
  ...
  attributes: {
    ...
    Transaction_Status: Attribute.String;
    payment_method: Attribute.Relation<
      'api::payment-transaction.payment-transaction',
      'manyToOne',
      'api::payment-method.payment-method'
    >;
    event_ticket: Attribute.Relation<
      'api::payment-transaction.payment-transaction',
      'oneToOne',
...
export interface ApiTransactionStatusTransactionStatus
  extends Schema.CollectionType {
  collectionName: 'transaction_statuses';
  info: {
    singularName: 'transaction-status';
    pluralName: 'transaction-statuses';
    displayName: 'Event_Ticket';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::event-organiser.event-organiser': ApiEventOrganiserEventOrganiser;
      'api::event-participant.event-participant': ApiEventParticipantEventParticipant;
      'api::event-registrant.event-registrant': ApiEventRegistrantEventRegistrant;
      'api::general-user.general-user': ApiGeneralUserGeneralUser;
      'api::invoice.invoice': ApiInvoiceInvoice;
      'api::payment-method.payment-method': ApiPaymentMethodPaymentMethod;
      'api::payment-transaction.payment-transaction': ApiPaymentTransactionPaymentTransaction;
      'api::transaction-status.transaction-status': ApiTransactionStatusTransactionStatus;
    }
  }
}
